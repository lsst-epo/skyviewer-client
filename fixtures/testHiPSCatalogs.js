...
export default [
  {
    type: "HiPS",
    url: "https://storage.googleapis.com/hips-data/catalog_stars",
    options: {
      name: "star",
      sourceSize: 20,
  ...
  {
    type: "HiPS",
    url: "https://storage.googleapis.com/hips-data/catalog_galaxies",
    options: {
      name: "galaxy",
      sourceSize: 20,
  ...
  {
    type: "HiPS",
    url: "https://storage.googleapis.com/hips-data/catalog_nebulae",
    options: {
      name: "nebula",
      sourceSize: 20,
  ...
  {
    type: "HiPS",
    url: "https://storage.googleapis.com/hips-data/catalog_transients",
    options: {
      name: "transient",
      sourceSize: 20,
  ...
  {
    type: "HiPS",
    url: "https://storage.googleapis.com/hips-data/catalog_goals",
    options: {
      name: "goal",
      sourceSize: 20,
  ...
  {
    type: "HiPS",
    url: "https://storage.googleapis.com/hips-data/catalog_landmarks",
    options: {
      name: "landmark",
      sourceSize: 20,
