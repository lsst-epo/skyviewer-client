...
export default function Chain({ className, size = 26, fill = "currentColor" }) {
  const uniqueProps = {
    viewBox: "0 0 26 26",
    width: size,
    height: size,
    ...
    <svg {...mergedSvgProps}>
      ...
      <defs>
        <clipPath id="clip-path">
          <rect width="26" height="26.001" fill="none" />
        </clipPath>
      </defs>
      <g transform="translate(13 13.001)">
        <g transform="translate(-13 -13.001)" clipPath="url(#clip-path)">
          <path
